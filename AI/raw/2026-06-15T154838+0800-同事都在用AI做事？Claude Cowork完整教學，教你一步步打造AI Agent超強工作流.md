...
用戶 [shenzhixiong16](https://www.threads.com/@edgeless.blade/post/DV-mPRsDhR5?xmt=AQF0J6pFnqqDw3e_GEylG-U-rQBTBBfPtRNtesco5mOcwm23NoeIJWu_g0hDsm5VDVgdPm4j) 在平臺上問：「常聽到同事炫耀工作都用 AI 做多輕鬆，不像我常被嫌工作做太慢、報告都沒有整理好……」帳號 [@edgeless.blade](https://www.threads.com/@edgeless.blade/post/DV-mPRsDhR5?xmt=AQF0J6pFnqqDw3e_GEylG-U-rQBTBBfPtRNtesco5mOcwm23NoeIJWu_g0hDsm5VDVgdPm4j) 的回覆只有兩句話：「辦一個 Claude 20 美元方案，下載 Claude Cowork app，把這些文字複製貼上，希望你也能開始解放大部分工作瑣事。」附上的，是一份完整的六步驟設定提示詞。

而本文除了整理 @edgeless.blade 的六步驟設定流程，也參考了 X 平臺帳號 [@heynavtoor](https://x.com/heynavtoor/status/2028148844891152554) 發表的「17個讓 Claude Cowork 強大100倍的最佳實踐」一文，在各步驟中補充了更進階的工作視角，讓你不只知道怎麼做，更能理解背後的原理。
...
X 平臺的 @heynavtoor 用一句話點出了更本質的差異：大多數人把時間花在優化提示詞，這套方法是在建立系統。
...
前往 [claude.ai](http://claude.ai/) ，升級至 Pro 方案，月費為 20 美元（約臺幣 650 元）。免費版不支援 Claude Cowork 所需的完整工具呼叫功能。
...
2. 如果檔案是空的，直接寫入下方內容；如果已有內容，將現有內容和下方內容合併後寫回，不要刪掉原本的東西
...
2. 讀取 _context/about-me.md 瞭解我是誰、我在做什麼
...
要特別注意的是，Cowork 工作環境綁定本地電腦。如果需要在多臺裝置間切換，必須手動同步工作空間資料夾（例如透過 iCloud 或 Google Drive）。
