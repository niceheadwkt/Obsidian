...
此舉被視為 Anthropic 在生成式 AI 市場中，針對教育與專業知識領域的重要布局。就在本週早些時候，OpenAI 才為 ChatGPT 推出了可解釋科學概念的互動功能；Google 的 Gemini 也具備類似的教育圖像生成能力。Anthropic 透過整合 Figma 、Canva 與 Slack 等工具，正試圖將 Claude 打造為更全能的協作平台。這種「畫給你看」的模式，正成為每個 AI 公司都在搶佔的領域。
