---
title: "Claude進階技巧懶人包！7個提示詞，讓AI從答題機變「會反駁你」的思考夥伴"
source: "https://www.bnext.com.tw/article/90564/claude-knowledge-workers-tips"
author:
  - "[[數位時代 BusinessNext]]"
published: 2026-04-10
created: 2026-06-15
description: "Claude 進階用法不在於「問一題、收一答」，而是把它當會反駁你的思考夥伴：問題是，提示詞怎麼下？"
tags:
  - "clippings"
---
...
2026.04.10 | [AI與大數據](https://www.bnext.com.tw/categories/ai)

Claude 進階用法不在於「問一題、收一答」，而是把它當會反駁你的思考夥伴：問題是，提示詞怎麼下？
...
一則 X 貼文直接點破多數人的使用盲區：「90% 的人用 [Claude](https://claude.ai/) 的方式，跟用『文法比較好的搜尋引擎』沒兩樣。」

這篇由 X 用戶 [@sharbel](https://x.com/sharbel) 發布的長串推文，整理出 12 個 Claude 進階技巧，引發大量轉發與討論。

@sharbel的核心觀點很明確：把 Claude 當成「會反駁你的思考夥伴」，而不是一臺更聰明的答題機。他讓 Claude 先問問題、建框架、挑毛病，最後才產出內容。
...
在 Claude 的 [Projects](https://support.anthropic.com/en/articles/9517075-what-are-projects) 功能中，上傳 5 到 10 篇你自己寫的文章，然後加入一句指令。從此在這個 Project 中的每次對話，Claude 都會自動匹配你的語氣、句式和用詞習慣。
...
> 延伸閱讀： [「全員AI」為何是AI轉型失敗的開始？華頓商學院教授：2種協作模式，才能真正釋放生產力](https://www.bnext.com.tw/article/90563/avoid-ai-workslop-collaboration-strategy)

資料來源： [@sharbel](https://x.com/sharbel/status/2041884808809226574)
