---
title: "一個Chrome擴充，讓NotebookLM幫你把YouTube精華轉成大師知識庫，隨時線上請教！"
source: "https://www.bnext.com.tw/article/90747/build-a-youtube-creator-master-knowledge-base-with-notebooklm"
author:
  - "[[數位時代 BusinessNext]]"
published: 2026-04-27
created: 2026-06-15
description: "本文介紹如何用 Chrome 擴充功能「YouTube to NotebookLM」，快速建立某位創作者的完整知識庫。"
tags:
  - "clippings"
---
...
2026.04.27 | [職場/工作術](https://www.bnext.com.tw/categories/digitalskill)

本文介紹如何用 Chrome 擴充功能「YouTube to NotebookLM」，快速建立某位創作者的完整知識庫。

[＃一天一AI](https://www.bnext.com.tw/tags/%E4%B8%80%E5%A4%A9%E4%B8%80AI)

---

昨天看到一個 [很酷的 NotebookLM 功能](https://www.bnext.com.tw/article/90198/youtube-to-notebooklm-create-your-personal-knowledge-library) ，感覺很值得分享！

這是 Chrome 擴充套件叫「 [YouTube to NotebookLM](https://www.bnext.com.tw/article/90198/youtube-to-notebooklm-create-your-personal-knowledge-library) 」，可以一次選整個 YT 頻道，把所有影片匯入 NotebookLM，建成那位創作者的完整知識庫。

像不像得到了大師的醍醐灌頂、精華傳承？

掌握最新AI、半導體、數位趨勢！訂閱《數位時代》日報及社群活動訊息

![#2 一天一AI](https://image-cdn.learnin.tw/bnextmedia/image/album/2026-04/73fz-1776831706.jpg?w=1200&output=webp)

圖／ 一天一AI

## 1\. 只要 5 分鐘，建好你的大師知識庫

不用複雜的操作，透過瀏覽器擴充功能就能輕鬆搞定：

- 安裝外掛：首先，安裝 Chrome 擴充功能「YouTube to NotebookLM」。
- 一鍵匯入：打開你想要深度學習的 YouTube 頻道首頁，點擊瀏覽器上的 NotebookLM 外掛圖示，就能將所有影片連結一鍵匯入 NotebookLM 中。
- 精準篩選：如果該頻道裡的影片數量實在太多，你也可以選擇只匯入特定的「播放清單」。

稍等幾分鐘，你的專屬知識庫就建置完成了！

![#4 一天一AI](https://image-cdn.learnin.tw/bnextmedia/image/album/2026-04/j7s7-1776831707.jpg?w=1200&output=webp)

圖／ 一天一AI

## 2\. 提問訣竅：不要只問摘要，要問「行動與建議」

建好知識庫後，「怎麼提問」才是挖掘寶藏的關鍵。我最推薦拿具體的情境和這個創作者的知識交流！進到 NotebookLM 筆記本後，提問時最好帶入你個人的具體目標。

比如匯入教你自媒體經營的創作者所有內容，問 NotebookLM「我擅長的領域是\[\]，想從2026年開始做自媒體，幫我列一份可執行的每日 SOP，包含每週、每日的關鍵任務。」

![#0 一天一AI](https://image-cdn.learnin.tw/bnextmedia/image/album/2026-04/fhjy-1776831706.jpg?w=1200&output=webp)

圖／ 一天一AI

## 3\. 不確定該怎麼問？先請 AI 幫你「建立知識框架」

如果你面對龐大的知識庫毫無頭緒，不知道從何問起，不妨先讓 AI 幫你梳理出學習脈絡。

你可以向 NotebookLM 這樣提問：

「根據我上傳的所有素材，生成：

1. 深入研究這個主題的人，應該能夠回答的 10 個最重要問題。
2. 我的素材已引發，但尚未回答的 5 個問題。
3. 針對那 5 個開放問題，各需要什麼類型的額外資料、文獻或研究才能解答？ 」

![#1 一天一AI](https://image-cdn.learnin.tw/bnextmedia/image/album/2026-04/s58a-1776831706.jpg?w=1200&output=webp)

圖／ 一天一AI

> 延伸閱讀： [超好用NotebookLM擴充！5步驟收藏上百小時YouTube精華，打造個人專屬知識庫](https://www.bnext.com.tw/article/90198/youtube-to-notebooklm-create-your-personal-knowledge-library)

## 選頻道前一定要知道的事

請務必記得，NotebookLM 的回答品質，完全取決於你匯入的素材。 如果你挑選的頻道主題太過發散（例如什麼都聊的雜談頻道），AI 給出的計畫與建議也會跟著鬆散。

因此，強烈建議挑選「長期聚焦同一個主題」的創作者頻道來建立知識庫，這樣問出來的內容才會足夠具體、有深度且具備高度實用性。

![#3 一天一AI](https://image-cdn.learnin.tw/bnextmedia/image/album/2026-04/npfq-1776831706.jpg?w=1200&output=webp)

圖／ 一天一AI

各位觀眾～貓貓開了 [贊助區塊](https://portaly.cc/1day.1ai/support) ，歡迎來 donate，讓貓貓有錢錢買貓糧，繼續為大家創作好的內容啊～
...
> 延伸閱讀：  
> [ChatGPT Images 2.0風格實測！日系手繪風、學習筆記、IG圖卡…8種好用提示詞一次收](https://www.bnext.com.tw/article/90765/chatgpt-image2.0-style-prompts)
> 
> [網址不用慢慢貼！NotebookLM＋擴充功能Grabbit，一鍵整理大量影片精華，操作步驟一次看](https://www.bnext.com.tw/article/90195/notebooklm-grabbit)

關鍵字： [＃一天一AI](https://www.bnext.com.tw/tags/%E4%B8%80%E5%A4%A9%E4%B8%80AI)
