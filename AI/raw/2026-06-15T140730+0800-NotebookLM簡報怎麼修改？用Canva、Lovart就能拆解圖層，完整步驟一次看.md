---
title: "NotebookLM簡報怎麼修改？用Canva、Lovart就能拆解圖層，完整步驟一次看"
source: "https://www.bnext.com.tw/article/85379/notebooklm-lovart-canva"
author:
  - "[[支琬清]]"
published: 2026-01-01
created: 2026-06-15
description: "NotebookLM 生成簡報之後，該怎麼修正？《經理人》實測如何透過 Lovart、Canva 等平臺拆解圖片、進一步修正。"
tags:
  - "clippings"
---
...
2026.01.01 | [AI與大數據](https://www.bnext.com.tw/categories/ai)

## 教學｜NotebookLM簡報怎麼修改？用Canva、Lovart就能拆解圖層，完整步驟一次看

NotebookLM 生成簡報之後，該怎麼修正？《經理人》實測如何透過 Lovart、Canva 等平臺拆解圖片、進一步修正。

[＃AI工具](https://www.bnext.com.tw/tags/AI%E5%B7%A5%E5%85%B7) [＃NotebookLM](https://www.bnext.com.tw/tags/NotebookLM)

---

還在一頁一頁做簡報？ [NotebookLM](https://www.bnext.com.tw/article/81728/notebooklm-tutorial) 　近期更新之後，使用者可以直接將資料來源生成簡報。儘管目前已經可以生成近乎正確的中文，但不少用戶反應，仍有修改簡報的需求。

事實上，NotebookLM 可以在生成簡報時，藉由調整 prompt，大幅度減少需要修正的內容；或是透過 Lovart、Canva 等平臺拆解圖片、進一步修正。

## NotebookLM 簡報、圖表生成教學
...
![#0 NotebookLM 簡報](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/5x7s-1764577827.png?w=1200&output=webp)

圖／ NotebookLM

2.利用 NotebookLM 生成簡報大綱，直接複製文字內容，設為新的資料來源。

![#1 NotebookLM 簡報](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/wkud-1764577829.png?w=1200&output=webp)

圖／ NotebookLM

3.取消選取其他資料來源，僅勾選簡報大綱。

![#3 NotebookLM 簡報](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/cckk-1764577831.png?w=1200&output=webp)

圖／ NotebookLM

4.點選「工作室」中「簡報」按鈕旁的鉛筆符號，可以調整生成的詳細內容，如語言、長度或是自行輸入需要的指令。

![#5 NotebookLM 簡報](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/6wif-1764577831.png?w=1200&output=webp)

圖／ NotebookLM

![#4 NotebookLM 簡報](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/mebd-1764577831.png?w=1200&output=webp)

圖／ NotebookLM

5.NotebookLM 生成的簡報僅能下載 PDF 格式，若有後製需求，需要另外轉成圖片檔，如 png 或 jpg 檔。

![NotebookLM 簡報](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/d1zf-1764578240.png?w=1200&output=webp)

圖／ NotebookLM

### 如何用 NotebookLM 生成圖表？

NotebookLM 同樣可以生成資訊圖表，經《經理人》實測，直接生成的圖表內容雖然豐富，但資訊內容一旦過於龐大，後續修正相對困難，建議在「資訊圖表」的中加入「 **字少** 」的指令。

1.點選「工作室」中「資訊圖表」按鈕旁的鉛筆符號。

![NotebookLM 資訊圖表](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/xp7f-1764578341.png?w=1200&output=webp)

圖／ NotebookLM

2.可以調整生成指令，目前實測「詳細程度」選擇精簡，並輸入「字少」指令，可以大幅縮短後續修正時間。

圖／ NotebookLM

![#1 NotebookLM 資訊圖表](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/3g9c-1764578550.png?w=1200&output=webp)

圖／ NotebookLM

## NotebookLM簡報怎麼修改？

### 方式一：下載「圖片檔」，用 Lovart 修改

1.將轉換成圖片檔的簡報上傳至 Lovart，點選圖片上方的「編輯元素」，平臺會自動讀取、產生新檔案。

![#0 Lovart 簡報修正](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/dsdu-1764578099.png?w=1200&output=webp)

圖／ Lovart

2.新生成的圖片可以直接編輯文字，包含字體、大小、排列方式等。

![#1 Lovart 簡報修正](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/qanf-1764578099.png?w=1200&output=webp)

圖／ Lovart

3.選取所有圖層後合併圖層，右鍵可選輸出檔案格式。

![#2 Lovart 簡報修正](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/4ejg-1764578099.png?w=1200&output=webp)

圖／ Lovart

#### 《經理人》實測小筆記：

- Lovart 雖然可以編輯元素，但若過於複雜的圖片無法順利拆解文字內容。
- Lovart 在拆解文字時，可能會自動將文字轉為簡體字，需要自行重新編輯。
- Lovart 編輯元素後，新圖片可能產生色差。

### 方式二：下載圖片檔，用Canva「編輯」功能修改

1.將轉換成圖片檔的簡報上傳至 Canva，使用「編輯」中的「Brush」選取文字內容，Canva 即可將文字部分轉為另一個圖層。

![#0 Canva 簡報修正](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/c84s-1764578039.png?w=1200&output=webp)

圖／ Canva

![#1 Canva 簡報修正](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/jwjb-1764578039.png?w=1200&output=webp)

圖／ Canva

2.讀取之後，原圖層可能會留下汙漬，使用魔法橡皮擦即可移除。

![#2 Canva 簡報修正](https://image-cdn.learnin.tw/bnextmedia/image/album/2025-12/idtb-1764578039.png?w=1200&output=webp)

圖／ Canva

#### 《經理人》實測小筆記：

- Canva 與 Lovart 相同，若是過於複雜的圖片，無法順利拆解文字內容。
- 圖片若有材質紋路，會在使用魔法橡皮擦之後，一併消除材質樣式。

本文授權轉載自 [《經理人月刊》](https://www.managertoday.com.tw/articles/view/71339)

關鍵字： [＃AI工具](https://www.bnext.com.tw/tags/AI%E5%B7%A5%E5%85%B7) [＃NotebookLM](https://www.bnext.com.tw/tags/NotebookLM)
...
00:44
 ...
 <video controls=""><source src="https://gnetwork.gliastudios.com/gnetwork/bnext.com.tw/bnext.com.tw-1781233570.751517.mp4?verify=1781502732-1Joc4I0XjBrxkBNYvPHA676Zp63XRKw8G%2B0OpQyHVzU%3D"> <source src="https://gnetwork.b-cdn.net/studio_backend/bnext.com.tw/bnext.com.tw-1781233570.751517.mp4?token=MHOL6uN_uo6G9IzCG7XW6g7_YoD2kzuHV2IqsN1h35A&amp;expires=1781589132"></video>
