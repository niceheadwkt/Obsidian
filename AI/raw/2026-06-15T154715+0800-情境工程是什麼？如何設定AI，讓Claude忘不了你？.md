---
title: "情境工程是什麼？如何設定AI，讓Claude忘不了你？"
source: "https://www.bnext.com.tw/article/90407/anthropic-claude-code-how"
author:
  - "[[數位時代 BusinessNext]]"
published: 2026-03-25
created: 2026-06-15
description: "情境工程正取代提示工程！如何利用 3 個檔案＋工具串接，讓 Claude 變成長期熟你的 AI 同事？"
tags:
  - "clippings"
---
...
情境工程正取代提示工程！如何利用 3 個檔案＋工具串接，讓 Claude 變成長期熟你的 AI 同事？
...
在 X（前 Twitter）上，AI 工作流程研究者 @ [heynavtoor](https://x.com/heynavtoor/status/2036157094341255344) 整理了一套業界盛行的新架構 **情境工程（Context Engineering）** 。Anthropic 也已於 2025 年 9 月發布完整 [工程指南說明](https://www.anthropic.com/engineering/effective-context-engineering-for-ai-agents) 這套方法論。
...
你花了一小時調教出完美的提示詞，得到一份好稿件，關掉視窗。隔天重新開啟，AI 對你一無所知——你的寫作風格、客戶偏好、專案脈絡，全部歸零。你只是在跑一臺永遠不前進的跑步機。
...
設定完成後，輸入「整理我今天的會議，並確認信箱裡有沒有跟它們相關的郵件」，Claude 會跨平臺比對你的行事曆與信箱，產出一份需要你自己花 15 分鐘才能整理出來的簡報。
...
> 延伸閱讀： [Claude變身「史丹佛博士生」助理：研究生如何用9個提示，把40多篇論文變成研究報告？](https://www.bnext.com.tw/article/90291/ai-redefining-academic-research-literature-analysis)
...
> 延伸閱讀：  
> [同事都在用AI做事？Claude Cowork完整教學，教你一步步打造AI Agent超強工作流](https://www.bnext.com.tw/article/90369/how-to-claude-cowork-6-step)
> 
> [怎麼用Claude Cowork做簡報？6步驟圖解、3進階用法，一次量產出可編輯的PPT](https://www.bnext.com.tw/article/90392/claude-cowork-ai-ppt)

資料來源： [@heynavtoor on X](https://x.com/heynavtoor/status/2036157094341255344)
