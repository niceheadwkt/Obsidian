...
Google 的 NotebookLM 宣佈為「Video Overviews（影片總覽）」推出重大升級，導入 Gemini 的最新影像生成更新 Nano Banana（奈米香蕉），以生成貼合脈絡、助益理解的插圖與視覺素材。
